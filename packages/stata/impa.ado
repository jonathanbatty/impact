...
program define impa
	...
	forvalues i = 1 / `num_codesystems' {
		display as text _newline "Loading iMPA code definitions for: {bf:" %9s "`codesystem_`i''" "}"
		...
		mata: impa_load("`codesys'", code_lookup_`codesys')
	}
